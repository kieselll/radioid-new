...
func _animate_button(button: Button, button_scale: Vector2, button_position: Vector2, color: Color) -> void :
	...
	tween.parallel().tween_property(button, "position", button_position, 0.3).set_trans(Tween.TRANS_CIRC)
