...
var front_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_S.png")
var left_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_E.png")
var back_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_N.png")
var right_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_W.png")
var right_front_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_SE.png")
var left_front_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_SW.png")
var right_back_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_NE.png")
var left_back_texture: CompressedTexture2D = load("res://features/entities/assets/directional/man_NW.png")
